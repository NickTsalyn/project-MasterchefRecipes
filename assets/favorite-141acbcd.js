import"./pagination-93424437.js";const i=document.querySelector(".fav-list-recipes"),s=document.querySelector(".nothing"),a=document.querySelector(".fav-recipes"),c=document.querySelector(".fav-categories");let t="";const l=[];for(const e of l)console.log("t",e.title),t+=`            <li class="fav-recipe-card">
